            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                        {[
                            { label: 'Total Revenue', value: fmt(num(totals?.total_revenue)), sub: `${fmt(num(totals?.confirmed_revenue))} from delivered orders`, icon: TrendingUp, color: 'text-[#38bdf8]', gradient: 'bg-[#0d2a4a]', style: { backgroundImage: 'radial-gradient(ellipse at top right, #1a4a7a 0%, #0d2a4a 60%)' }, dark: true, to: '/admin/orders' },
